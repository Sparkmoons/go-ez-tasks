...
За создание новых процессов отвечает единый системный вызов - NtCrwateProcess(). В нем много параметров, благодаря чему он обладает высокой мощностью и гибкостью в управлении процессами. 
