...
При плохом распределении хэша может поkeчится ситуация, когда в одну ячейку поместили N элементов и получили связанный список длиной N. Поиск по такому списку в худшем случае будет O(n), что неэффективнее чем поиск по массиву.
