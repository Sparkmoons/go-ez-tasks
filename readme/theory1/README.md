...
Интерфейсы помогают сделать программу SOLIDной. Их стоит рассматривать как контракт между функией/методом и аргументом, который она принимает. Происходит инверсия зависимостей (Функции говорим: без разницы какой аргумент, важно, чтобы был такоц метод). 
